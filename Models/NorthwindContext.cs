...
namespace DbFirst_Nortwind.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<PahaliUrun> PahaliUruns { get; set; } = null!;
        ...
        public virtual DbSet<TopCondiment> TopCondiments { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=DESKTOP-2QLMN3P\\CEYLAN;Database=Northwind;User ID=SA;Password=1234567; ");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PahaliUrun>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("PahaliUrun");
            ...
            modelBuilder.Entity<TopCondiment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("TopCondiments");
